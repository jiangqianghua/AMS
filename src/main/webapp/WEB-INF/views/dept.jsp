...
<script type="application/javascript">
    $(function() {
        ...
        function loadDeptTree() {
            $.ajax({
                url: "/AuthorityManagementSystem/sys/dept/tree.json",
        ...
        function bindDeptClick() {
            ...
            $(".dept-delete").click(function (e) {
                ...
                if (confirm("确定要删除部门[" + deptName + "]吗?")) {
                    $.ajax({
                        url: "/AuthorityManagementSystem/sys/dept/delete.json",
                        data: {
                            id: deptId
                        },
                        success: function (result) {
        ...
        function updateDept(isCreate, successCallback, failCallback) {
            $.ajax({
                url: isCreate ? "/AuthorityManagementSystem/sys/dept/save.json" : "/AuthorityManagementSystem/sys/dept/update.json",
